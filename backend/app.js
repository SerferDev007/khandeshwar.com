...
class CrudController {
  ...
  async create(req, res) {
    try {
      const entityData = { ...req.body, id: generateId(), createdAt: new Date().toISOString() };
  ...
  async update(req, res) {
    try {
      ...
      const [existingRows] = await connection.execute(`SELECT * FROM ${this.tableName} WHERE id = ?`, [id]);
...
const uploadedFileController = new CrudController('uploaded_files', UploadedFile);
...
app.put('/api/agreements/:id', (req, res) => agreementController.update(req, res));
...
// Rent Penalty routes
app.get('/api/rent-penalties', (req, res) => rentPenaltyController.getAll(req, res));
app.get('/api/rent-penalties/:id', (req, res) => rentPenaltyController.getById(req, res));
app.post('/api/rent-penalties', (req, res) => rentPenaltyController.create(req, res));
app.put('/api/rent-penalties/:id', (req, res) => rentPenaltyController.update(req, res));
app.delete('/api/rent-penalties/:id', (req, res) => rentPenaltyController.delete(req, res));

// Transaction routes
app.get('/api/transactions', (req, res) => transactionController.getAll(req, res));
app.get('/api/transactions/:id', (req, res) => transactionController.getById(req, res));
app.post('/api/transactions', (req, res) => transactionController.create(req, res));
app.put('/api/transactions/:id', (req, res) => transactionController.update(req, res));
app.delete('/api/transactions/:id', (req, res) => transactionController.delete(req, res));

// Uploaded File routes
app.get('/api/uploaded-files', (req, res) => uploadedFileController.getAll(req, res));
app.get('/api/uploaded-files/:id', (req, res) => uploadedFileController.getById(req, res));
app.post('/api/uploaded-files', (req, res) => uploadedFileController.create(req, res));
app.put('/api/uploaded-files/:id', (req, res) => uploadedFileController.update(req, res));
app.delete('/api/uploaded-files/:id', (req, res) => uploadedFileController.delete(req, res));

// Additional useful endpoints

// Get files by entity
app.get('/api/uploaded-files/entity/:entityType/:entityId', async (req, res) => {
  try {
