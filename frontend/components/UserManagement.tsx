      ...
      <Card>
                ...
                <div>
                  ...
                  <Select value={formData.role} onValueChange={(value: any) => setFormData({...formData, role: value})}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Treasurer">{t('users.treasurer')}</SelectItem>
                      <SelectItem value="Viewer">{t('users.viewer')}</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <Button type="submit" className="w-full">{t('users.addUser')}</Button>
              </form>
            </DialogContent>
          </Dialog>
        </CardHeader>
        <CardContent>
          <Alert className="mb-4">
            <AlertDescription>
              <strong>{t('users.rolePermissions')}</strong><br />
              <strong>{t('users.admin')}:</strong> {t('users.adminDesc')}<br />
              <strong>{t('users.treasurer')}:</strong> {t('users.treasurerDesc')}<br />
      ...
      <Dialog open={!!editingUser} onOpenChange={() => setEditingUser(null)}>
        <DialogContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full">{t('users.updateUser')}</Button>
          </form>
        </DialogContent>
      </Dialog>
    </div>
